...
const timeline = [
  ...
  { year: "۱۳۹۵", fa: "گسترش به مرمر و گرانیت. افتتاح شوروم پریمیوم." },
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              <div>
                ...
                <p className="text-[#1d2330]/70 leading-relaxed mb-5">
                  مرجع سنگ ایرانیان در سال ۱۳۸۹ توسط خانواده واصغ تأسیس شد و به زودی به یکی از بازیگران اصلی بازار سنگ طبیعی ایران تبدیل گردید.
                </p>
                <p className="text-[#1d2330]/70 leading-relaxed mb-5">
